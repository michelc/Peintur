...
namespace Peintur.Controllers
{
    public class TableauxController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Nom,Annee,Technique,Sujet,Support,Cadre,Stockage,Taille,Poids,Commentaires")] Tableau tableau)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Tableau_ID,Nom,Annee,Technique,Sujet,Support,Cadre,Stockage,Taille,Poids,Commentaires")] Tableau tableau)
        {
            if (ModelState.IsValid)
            {
